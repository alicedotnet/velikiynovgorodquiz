...
namespace VNQuiz.Alice.Tests.TestsInfrastructure
{
    static class TestsConstants
    {
        public static class Assets
        {
            ...
            public const string AllAchievementsUnlockedFilePath = _assetsFolder + "AllAchievementsUnlocked.json";
            public const string AnswerNeedMoreInfo = _assetsFolder + "Answer_NeedMoreInfo.json";
