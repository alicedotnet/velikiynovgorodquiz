...
namespace VNQuiz.Alice.Models
{
    public class QuizResponseBaseReturn
    {
        ...
        public QuizSessionState? SessionState
        {
            get;
            set;
        }
        ...
        public QuizUserState? UserStateUpdate
        {
            get;
            set;
        }
        ...
        public QuizUserState? ApplicationState
        {
            get;
            set;
        }
        ...
        [JsonIgnore]
        public QuizUserState? UserOrApplicationState
        {
            get
            {
